...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_major'] = $this->language->get('text_major');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['degree'] = $this->url->link('config/degree', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['major'] = $this->url->link('config/major', 'token=' . $this->session->data['token'], 'SSL');
