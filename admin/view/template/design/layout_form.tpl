            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><select name="layout_module[<?php echo $module_row; ?>][position]" class="form-control">
                    ...
                    <?php } ?>
                    <?php if ($layout_module['position'] == 'product_tab') { ?>
                    <option value="product_tab" selected="selected"><?php echo $text_product_tab; ?></option>
                    <?php } else { ?>
                    <option value="product_tab"><?php echo $text_product_tab; ?></option>
                    <?php } ?>
                  </select></td>
...
function addModule() {
    ...
    html += '    <option value="product_tab"><?php echo $text_product_tab; ?></option>';
    html += '  </select></td>';
