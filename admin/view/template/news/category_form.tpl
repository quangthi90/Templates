              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="news_category_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($news_category_description[$language['language_id']]) ? $news_category_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="news_category_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($news_category_description[$language['language_id']]) ? $news_category_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
                ...
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-left"><select name="news_category_layout[0]" class="form-control">
                          <option value=""></option>
                    ...
                    <tr>
                      ...
                      <td class="text-left"><select name="news_category_layout[<?php echo $store['store_id']; ?>]" class="form-control">
                          <option value=""></option>
                          <?php foreach ($layouts as $layout) { ?>
