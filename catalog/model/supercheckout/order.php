...
class ModelSupercheckoutOrder extends Model {		
        public function editCustomerId($order_id,$data){
            ...
            $this->db->query("UPDATE `" . DB_PREFIX . "order` set customer_id = '" . (int)$data['customer_id'] . "', date_modified = NOW() WHERE order_id = '" . (int)$order_id . "'");
