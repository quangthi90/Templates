...
class ControllerAffiliateOrder extends Controller {
	...
	public function index() {
		...
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('affiliate/order', 'order_id=' . $order_id, 'SSL');
		...
		if ($order_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('affiliate/transaction', $url, 'SSL')
			);

			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_order'),
				'href' => $this->url->link('affiliate/order', 'order_id=' . $this->request->get['order_id'] . $url, 'SSL')
			);
